...
EMCC_FLAGS="$EMCC_FLAGS -sSTACK_SIZE=1048576"
EMCC_FLAGS="$EMCC_FLAGS -sEXIT_RUNTIME=0"
EMCC_FLAGS="$EMCC_FLAGS -sINVOKE_RUN=1"
EMCC_FLAGS="$EMCC_FLAGS -sASYNCIFY"
EMCC_FLAGS="$EMCC_FLAGS -sASYNCIFY_IMPORTS=['wgpuInstanceRequestAdapter','wgpuAdapterRequestDevice','wgpuSurfaceGetPreferredFormat']"
