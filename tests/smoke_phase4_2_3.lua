...
if cjk_tool then
  ...
  check("cjk_tool: CJK charset definition",     cjk_tool:find("CHARSET_ZH_CN_CORE"))
  check("cjk_tool: hb_shape call",              cjk_tool:find("hb_shape%("))
  check("cjk_tool: hb_buffer_add_utf32",        cjk_tool:find("hb_buffer_add_utf32"))
  ...
  check("cjk_tool: 20 char core subset",         cjk_tool:find("20"))
  check("cjk_tool: cleanup hb_buffer_destroy",    cjk_tool:find("hb_buffer_destroy"))
...
if tables then
  ...
  check("tables: glyph_count = 20",                tables:find("NEBULA_CJK_GLYPH_COUNT <const> = 20"))
