...
local function _gen_process_text_input(lines, ctx)
  ...
  table.insert(lines,  "      -- ★ Phase 4.X: 接受所有可打印 Unicode 字符（排除 C0/C1 控制字符和 DEL）")
  ...
  table.insert(lines,  "      end")
  table.insert(lines,  "      -- ★ Phase 4.X: UTF-8 编码后逐字节插入 Gap Buffer")
  ...
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0xC0 | (cp >> 6)))")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0x80 | (cp & 0x3F)))")
  table.insert(lines,  "        changed = true")
  table.insert(lines,  "      elseif cp <= 0xFFFF then")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0xE0 | (cp >> 12)))")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0x80 | ((cp >> 6) & 0x3F)))")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0x80 | (cp & 0x3F)))")
  table.insert(lines,  "        changed = true")
  table.insert(lines,  "      elseif cp <= 0x10FFFF then")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0xF0 | (cp >> 18)))")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0x80 | ((cp >> 12) & 0x3F)))")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0x80 | ((cp >> 6) & 0x3F)))")
  table.insert(lines,  "        self.visual.gap_buf:insert_char((@uint8)(0x80 | (cp & 0x3F)))")
  table.insert(lines,  "        changed = true")
  table.insert(lines,  "      end")
  table.insert(lines,  "      if changed then")
  table.insert(lines,  "        self.selection_anchor = (@uint32)(self.visual.gap_buf:cursor())")
  table.insert(lines,  "      end")
  table.insert(lines,  "    end")
  ...
  table.insert(lines,  "      self.selection_anchor = (@uint32)(self.visual.gap_buf:cursor())")
  table.insert(lines,  "      changed = true")
  table.insert(lines,  "    elseif self.visual.gap_buf:delete_char_before() then")
  table.insert(lines,  "      self.selection_anchor = (@uint32)(self.visual.gap_buf:cursor())")
  table.insert(lines,  "      changed = true")
  table.insert(lines,  "    end")
  ...
  table.insert(lines,  "      self.selection_anchor = (@uint32)(self.visual.gap_buf:cursor())")
  table.insert(lines,  "      changed = true")
  table.insert(lines,  "    elseif self.visual.gap_buf:delete_char_after() then")
  table.insert(lines,  "      changed = true")
  table.insert(lines,  "    end")
